...
/**
 * Cloudflare Pages Function for /api/browse
 * Accepts POST JSON { type, query, limits, cPageNo }
...
export default async function (request) {
  try {
    ...
    const mainRes = await fetch("https://indcat.inflibnet.ac.in/index.php/main/book", { headers: { "User-Agent": "Mozilla/5.0" }});
